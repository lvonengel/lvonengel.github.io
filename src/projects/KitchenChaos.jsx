        ...
        <main>
            ...
            <section>
                ...
                <div className="buttonContributions">
                    <button onClick={() => setActiveSection(activeSection === "singleplayer" ? null : "singleplayer")}
                        className={activeSection === "singleplayer" ? "activeButton": ""}>
                        Single Player
                    </button>

                    <button onClick={() => setActiveSection(activeSection === "multiplayer" ? null : "multiplayer")}
                        className={activeSection === "multiplayer" ? "activeButton": ""}>
                        Multiplayer
                    </button>
