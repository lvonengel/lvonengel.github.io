...
export default function Pendar() {
    return (
        <main>
            ...
            <div className="columns">
                ...
                <p>
                    ...
                    autonomously manufactured components for handheld spectrometers, 
                    converting a previously manual process into an automated one.
                </p>
            </div>
